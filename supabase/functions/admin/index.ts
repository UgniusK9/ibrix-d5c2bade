...
const adminRequestSchema = z.discriminatedUnion('action', [
  ...
  z.object({ action: z.literal('create_product'), sku: z.string().min(1), slug: z.string().min(1), title: z.string().min(1), short_desc: z.string().nullable().optional(), description: z.string().nullable().optional(), price_eur: z.number().positive(), deposit_eur: z.number().min(0), sale_price_eur: z.number().nullable().optional(), cost_price_eur: z.number().nullable().optional(), credits_cost_eur: z.number().nullable().optional(), stock_status: z.enum(['preorder', 'in_stock', 'out_of_stock']), status: z.enum(['active', 'inactive']), category: z.enum(['engines', 'cars', 'flowers', 'other']), category_id: z.string().uuid().nullable().optional(), images: z.array(z.string()).optional(), badges: z.array(z.string()).optional(), tags: z.array(z.string()).optional(), preorder_eta_weeks_min: z.number().nullable().optional(), preorder_eta_weeks_max: z.number().nullable().optional(), inventory_qty: z.number().optional(), details_json: z.record(z.unknown()).nullable().optional() }),
  z.object({ action: z.literal('update_product'), productId: z.string().uuid(), sku: z.string().min(1).optional(), slug: z.string().min(1).optional(), title: z.string().min(1).optional(), short_desc: z.string().nullable().optional(), description: z.string().nullable().optional(), price_eur: z.number().positive().optional(), deposit_eur: z.number().min(0).optional(), sale_price_eur: z.number().nullable().optional(), cost_price_eur: z.number().nullable().optional(), credits_cost_eur: z.number().nullable().optional(), stock_status: z.enum(['preorder', 'in_stock', 'out_of_stock']).optional(), status: z.enum(['active', 'inactive']).optional(), category: z.enum(['engines', 'cars', 'flowers', 'other']).optional(), category_id: z.string().uuid().nullable().optional(), images: z.array(z.string()).optional(), badges: z.array(z.string()).optional(), tags: z.array(z.string()).optional(), preorder_eta_weeks_min: z.number().nullable().optional(), preorder_eta_weeks_max: z.number().nullable().optional(), inventory_qty: z.number().optional(), details_json: z.record(z.unknown()).nullable().optional() }),
